...
import type { HeroBanner, Category, Product, PublicSettings, ShowcaseItem } from '@/types';
...
export function HomePageClient({ initialHome }: HomePageClientProps) {
      ...
      {showcaseItems.length > 0 ? (
        ...
        >
          <div className="mx-auto max-w-[90rem] px-4 sm:px-6 lg:px-10">
            ...
            <div className="mt-8 -mx-4 overflow-x-auto overscroll-x-contain scroll-smooth px-4 pb-2 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden sm:-mx-6 sm:px-6 lg:-mx-10 lg:px-10">
